...
The Peggy Smart Contract is deployed on the Ropsten testnet at address: 0x3de4ef81Ba6243A60B0a32d3BCeD4173b6EA02bb. More details on the smart contracts and usage can be found in the bridge-contracts folder.
...
An api collection for Postman (https://www.getpostman.com/) is provided [here](./poc-cosmos.postman_collection.json) which documents some API endpoints and can be used to interact with it.
